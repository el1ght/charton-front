    ...
    <div className={"flex flex-col gap-y-3"}>
      {isAuthor ? (
        <div className={"flex items-center gap-x-2 ml-3"}>
          <Link
            href={"/artists/42352543"}
            className={"w-10 h-10 bg-neutral-400 rounded-full"}
          ></Link>
          <Link
            href={"/artists/42352543"}
            className={"text-[20px] font-bold text-color uppercase"}
          >
            {authorName}
          </Link>
        </div>
      ) : (
        <div className={"text-[18px] font-bold text-color ml-3"}>{title}</div>
      )}
      {isSimilar && (
        <div className={"flex items-center gap-x-2 ml-3"}>
          ...
          <div className={"flex flex-col gap-y-1"}>
            <p
              className={
                "uppercase text-[16px] font-normal subtitle-text-color leading-4"
              }
            >
              Similar to
            </p>
            <h4 className={"text-[20px] font-bold leading-5 text-color"}>
              {authorName}
            </h4>
          </div>
        </div>
